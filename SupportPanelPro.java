...
public class SupportPanelPro extends JPanel {
    public SupportPanelPro() {
        ...
        String[] faqs = {
            "Πώς μπορώ να διαχειριστώ τα ραντεβού μου;",
            "Πώς λειτουργεί το σύστημα πληρωμών;",
            "Πώς μπορώ να ενημερώσω το προφίλ μου;",
            "Πώς μπορώ να δω τις κριτικές μου;"
        };

        String[] answers = {
            "Για να διαχειριστείτε τα ραντεβού σας, μεταβείτε στην ενότητα 'Ραντεβού' και επιλέξτε Επεξεργασία ή Ακύρωση.",
            "Το σύστημα πληρωμών υποστηρίζει χρεωστικές/πιστωτικές κάρτες και αντικαταβολή. Ο πελάτης δικαιούται να σας πληρώσει με οποιοδήποτε τρόπο επιθυμεί.",
            "Για να ενημερώσετε το προφίλ σας, κάντε κλικ στην ενότητα 'Το προφίλ μου'.",
            "Οι κριτικές σας εμφανίζονται στο προφίλ σας, στην καρτέλα 'Αξιολογήσεις'."
        };
